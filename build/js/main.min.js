...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.initVideos)();
  (0, _slider.initSliderCoaches)();
  (0, _slider.initSliderReviews)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/slider":11,"./modules/video":12,"./utils/ios-vh-fix":15,"./vendor/init-accordion":19,"./vendor/init-tabs":20}],2:[function(require,module,exports){
"use strict";
...
exports.initSliderReviews = exports.initSliderCoaches = void 0;
var initSliderCoaches = function initSliderCoaches() {
  var sliderCoaches = document.querySelector('[data-slider="coaches"]');
  var swiperCoaches = new window.Swiper(sliderCoaches, {
    loop: true,
    navigation: {
...
var initSliderReviews = function initSliderReviews() {
  var sliderReviews = document.querySelector('[data-slider="reviews"]');
  var swiperReviews = new window.Swiper(sliderReviews, {
    navigation: {
