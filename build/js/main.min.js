...
},{"./modules/form-validate/form":3,"./modules/slider":9,"./modules/video":10,"./utils/ios-vh-fix":12,"./vendor/init-accordion":15,"./vendor/init-tabs":16}],2:[function(require,module,exports){
"use strict";
...
var initSliderCoaches = function initSliderCoaches() {
  ...
  var swiperCoaches = new window.Swiper(sliderElement, {
    loop: true,
    navigation: {
...
var initSliderReviews = function initSliderReviews() {
  ...
  var swiperReviews = new window.Swiper(sliderElement, {
    navigation: {
...
},{"../utils/load-script.js":13}],11:[function(require,module,exports){
"use strict";
